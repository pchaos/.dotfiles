...
_G.packer_plugins = {
  ...
  ["Nvim-Switch-Buffer"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/Nvim-Switch-Buffer",
  ...
  ["csv.vim"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/csv.vim",
  ...
  ["fcitx5-status"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/fcitx5-status",
  ...
  ["timestamp.vim"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/timestamp.vim",
  ...
  ["vim-tetris"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/vim-tetris",
    url = "https://github.com/adelarsq/vim-tetris"
  }
}
